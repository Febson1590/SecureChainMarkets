"""Write all remaining refactored pages for SECURECHAINMARKETS."""
import pathlib, os

BASE = pathlib.Path(r"C:\Users\samso\OneDrive\Documents\Code\projects\broker\SECURECHAINMARKETS")
...
export const metadata: Metadata = { title: "Investments \\u2014 SECURECHAINMARKETS" };
...
export const metadata: Metadata = { title: "Copy Trading \\u2014 SECURECHAINMARKETS" };
