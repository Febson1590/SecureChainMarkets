...
const STATUS_META: Record<UiStatus, {
  ...
  review:   { label: "Under Review",     color: "text-[#e8c178]",     bg: "bg-[#d4a857]/12",     border: "border-[#d4a857]/25",     Icon: Hourglass  },
        ...
        {activeWallet ? (
          <>
            ...
            <div className="space-y-1.5">
              ...
              <div className="flex items-stretch gap-2">
                ...
                <button
                  ...
                  className="h-11 w-11 rounded-lg bg-[#d4a857]/12 border border-[#d4a857]/25 flex items-center justify-center text-[#d4a857] hover:bg-[#d4a857]/20 transition-colors"
                >
            ...
            {activeWallet.instructions && (
              <div className="rounded-lg border border-[#d4a857]/20 bg-[#d4a857]/[0.05] px-3 py-2.5 text-[12px] text-slate-300 leading-relaxed whitespace-pre-wrap">
                {activeWallet.instructions}
              </div>
            )}
  ...
  return (
    <div className="rounded-xl border border-white/[0.07] bg-white/[0.02] px-4 py-3.5">
      <div className="flex items-center gap-1.5 mb-2.5">
        <Info size={12} className="text-[#d4a857]" />
      ...
      <ol className="space-y-2">
        {steps.map((step, i) => (
          <li key={i} className="flex items-start gap-2.5 text-[12.5px] text-slate-300 leading-relaxed">
            <span className="flex-shrink-0 mt-0.5 w-4 h-4 rounded-full bg-[#d4a857]/15 border border-[#d4a857]/30 text-[#e8c178] text-[10px] font-bold flex items-center justify-center">
              {i + 1}
            </span>
            <span>{step}</span>
          </li>
    ...
    <div className="rounded-2xl border border-white/[0.07] bg-white/[0.02] overflow-hidden">
      ...
      <div className="flex items-center gap-3 p-4">
        ...
        <div className="text-right flex-shrink-0">
          <div className="text-[14px] font-bold text-[#e8c178] tabular-nums">
        ...
        {ui === "awaiting" && (
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="inline-flex items-center gap-1.5 h-8 px-3 rounded-md bg-[#d4a857] hover:bg-[#d4a857] text-white text-[12px] font-semibold"
            >
              <Upload size={12} />
              Upload Proof
            </button>
    ...
    >
      ...
      >
        ...
        <div className="p-5 space-y-4">
          ...
          {file ? (
            <div className="flex items-center gap-3 rounded-lg px-3 py-3 bg-[#d4a857]/[0.06] border border-[#d4a857]/25">
            ...
            <button
              ...
              className="w-full rounded-lg px-4 py-6 text-center border border-dashed border-white/[0.15] hover:border-[#d4a857]/40 hover:bg-white/[0.02] transition-all"
            >
