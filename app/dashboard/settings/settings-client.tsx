      ...
      <Card className="glass-card border-0 rounded-xl p-6">
        <div className="flex items-center gap-3 mb-6">
          <div className="w-10 h-10 rounded-lg bg-[#d4a857]/12 border border-[#d4a857]/20 flex items-center justify-center">
            <User className="h-5 w-5 text-[#d4a857]" />
          </div>
          <div>
        ...
        <form onSubmit={handleSave} className="space-y-4">
          ...
          <Button
            ...
            className={`w-full h-11 font-semibold transition-all ${saved ? "bg-emerald-500 text-white" : "bg-[#d4a857] hover:bg-[#d4a857] text-white"}`}
          >
          ...
          <div className="p-4 bg-white/3 rounded-lg">
            ...
            {showPwdForm && (
              <form onSubmit={handlePasswordChange} className="mt-4 pt-4 border-t border-white/5 space-y-3">
                ...
                <Button type="submit" disabled={pwdLoading} className="w-full bg-[#d4a857] hover:bg-[#d4a857] text-white font-semibold h-10 text-sm">
