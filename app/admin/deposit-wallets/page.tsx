...
function WalletModal({
  ...
  return (
    ...
    >
      <div
        className="glass-card border border-[#d4a857]/20 rounded-2xl p-6 w-full max-w-md shadow-2xl"
    ...
    <div className="space-y-5">
      ...
      <div className="flex items-start justify-between gap-3 flex-wrap">
        ...
        <Button
          ...
          className="bg-[#d4a857] hover:bg-[#d4a857] text-white font-semibold"
        >
      ...
      <div className="glass-card rounded-xl p-4 flex items-center gap-2">
        <Wallet className="h-4 w-4 text-[#d4a857]" />
                    ...
                    <td className="px-4 py-3">
                      <div className="flex items-center gap-2">
                        ...
                        <button
                          ...
                          className="text-slate-500 hover:text-[#d4a857] transition-colors flex-shrink-0"
