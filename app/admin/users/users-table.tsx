                  ...
                  <tr key={user.id} className="border-b border-white/[0.04] hover:bg-white/[0.02] transition-colors">
                    <td className="px-4 py-3">
                      <div className="flex items-center gap-2.5">
                        <div className="w-8 h-8 rounded-full bg-[#d4a857]/12 border border-[#d4a857]/20 flex items-center justify-center text-xs font-bold text-[#d4a857] flex-shrink-0">
                      ...
                      <div className="flex items-center gap-1.5">
                        <Link href={`/admin/users/${user.id}`}>
                          <Button
                            size="sm"
                            variant="outline"
                            className="border-[#d4a857]/20 text-[#d4a857] hover:bg-[#d4a857]/12 h-7 text-xs px-2"
                          >
