      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
        ...
        <div className="glass-card rounded-xl p-5 space-y-4">
          <div className="flex items-center gap-2 mb-1">
            <Bell className="h-4 w-4 text-[#d4a857]" />
          ...
          <div className="space-y-1.5">
            ...
            <Select value={userId} onValueChange={(v) => v !== null && setUserId(v)}>
              ...
              <SelectContent className="bg-[#0E1A30] border-[#d4a857]/20 text-white max-h-60 overflow-y-auto">
                <SelectItem value="all" className="hover:bg-[#d4a857]/12 focus:bg-[#d4a857]/12">
                ...
                {users.map((u: any) => (
                  <SelectItem key={u.id} value={u.id} className="hover:bg-[#d4a857]/12 focus:bg-[#d4a857]/12">
                    {u.name} ({u.email})
                  </SelectItem>
                ))}
              </SelectContent>
            ...
            <Select value={type} onValueChange={(v) => v !== null && setType(v)}>
              ...
              <SelectContent className="bg-[#0E1A30] border-[#d4a857]/20 text-white">
                {["INFO", "SUCCESS", "WARNING", "ERROR"].map((t) => (
                  <SelectItem key={t} value={t} className="hover:bg-[#d4a857]/12 focus:bg-[#d4a857]/12">{t}</SelectItem>
                ))}
              </SelectContent>
            </Select>
          </div>
          ...
          <Button onClick={handleSend} disabled={loading || !title || !message} className="w-full bg-[#d4a857] hover:bg-[#d4a857] text-white font-semibold h-10 text-sm">
