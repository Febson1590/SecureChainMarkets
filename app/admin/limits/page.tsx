...
const inputCls =
  "w-full bg-white/[0.06] border border-white/[0.15] rounded-lg px-3 py-2 text-white text-sm placeholder:text-slate-500 focus:outline-none focus:border-[#d4a857]/60";
    ...
    <div className="space-y-5 max-w-2xl">
      ...
      <div>
        <h1 className="text-2xl font-bold text-white flex items-center gap-2">
          <SlidersHorizontal size={18} className="text-[#d4a857]" />
      ...
      {loading ? (
        ...
        <div className="space-y-4">
          ...
          <div className="glass-card rounded-2xl p-5 sm:p-6 space-y-4">
            <div className="flex items-center gap-2">
              <div className="w-8 h-8 rounded-md bg-[#d4a857]/12 border border-[#d4a857]/25 flex items-center justify-center">
                <ArrowUpFromLine size={14} className="text-[#d4a857]" />
              </div>
              <div>
          ...
          <div className="flex justify-end">
            <Button
              onClick={save}
              disabled={saving}
              className="bg-[#d4a857] hover:bg-[#d4a857] text-white font-semibold h-10 px-5"
            >
              {saving ? (
