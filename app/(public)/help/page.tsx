...
const faqs = [
  ...
  },
  {
    ...
    a: "From your dashboard, open the Verification section and upload a government-issued ID along with a short selfie. Submissions go through a manual review process — most are processed within one business day.",
  },
  {
    q: "How do deposits and withdrawals work?",
    a: "Deposits and withdrawals are processed through your Wallets page. Every request goes through a verification step to help protect your account. Processing time depends on the method and network conditions.",
  },
  {
