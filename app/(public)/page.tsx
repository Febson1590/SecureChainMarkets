...
const features = [
  {
    ...
    desc: "Buy and sell supported digital assets with market or limit orders and clear, itemised confirmations.",
  },
  {
    icon: BarChart3,
    title: "Investment Plans",
    desc: "Structured plans with stated terms — review the plan details and risk information before participating.",
  },
  {
    icon: Users,
    title: "Copy Trading",
    desc: "Mirror selected traders' activity in your own account. Transparent performance history; pause or exit any time.",
  },
  {
    icon: LayoutGrid,
    title: "Wallet Management",
    desc: "Manage deposit and withdrawal addresses with reviewable activity and per-asset balances.",
  },
  {
    icon: ShieldCheck,
    title: "Account Verification",
    desc: "Identity verification is required before funding. Submissions go through a manual review process before approval.",
  },
  {
    icon: Eye,
    title: "Transaction Monitoring",
    desc: "Every deposit, trade, and withdrawal is logged with timestamps and visible in your activity history.",
  },
];
...
export default async function HomePage() {
  ...
  return (
    <div className="hero-bg overflow-x-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.35fr)] gap-8 lg:gap-10 items-start">
            ...
            <div className="pt-6 lg:pt-10 min-w-0 w-full">
              ...
              <div className="flex flex-wrap items-center gap-x-4 gap-y-2 text-[11px] text-slate-500 mb-7">
                <span className="inline-flex items-center gap-1.5"><CheckCircle2 size={12} className="text-emerald-400" /> Secure Account Access</span>
                <span className="inline-flex items-center gap-1.5"><CheckCircle2 size={12} className="text-emerald-400" /> KYC Verification</span>
                <span className="inline-flex items-center gap-1.5"><CheckCircle2 size={12} className="text-emerald-400" /> Real-Time Portfolio Tracking</span>
              </div>
      ...
      ══════════════════════════════════════════════════════════════════ */}
      <section
        className="pt-10 pb-12 px-4 sm:px-6 lg:px-8 relative"
        style={{
          background:
            "linear-gradient(180deg, transparent 0%, rgba(8,17,31,0.6) 50%, transparent 100%)",
        }}
      >
        <div
          aria-hidden
        ...
        <div className="max-w-7xl mx-auto relative">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
            {credibility.map((c) => (
              <div
                key={c.title}
                className="vx-panel vx-panel-hover p-5 flex items-start gap-4"
              >
                <div
          ...
          <div className="mb-6 flex items-end justify-between gap-6 flex-wrap">
            <div>
              ...
              <h2 className="text-[26px] sm:text-[30px] font-bold text-white tracking-tight leading-[1.1] max-w-xl">
                Chart, depth and orders
                <br />
                <span className="gradient-text">in a single view.</span>
              </h2>
            </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden"
        ...
        <div className="max-w-7xl mx-auto">
          <div className="max-w-2xl mb-10">
            <div className="vx-eyebrow mb-3">Platform</div>
            <h2 className="text-[26px] sm:text-[32px] font-bold text-white tracking-tight leading-[1.1]">
              Everything you need to{" "}
              <span className="gradient-text">trade with precision.</span>
            </h2>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden"
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-[minmax(0,1fr)_minmax(0,1fr)] gap-12 items-start">
            <div>
              <div className="vx-eyebrow mb-2">Security</div>
              <h2 className="text-[26px] sm:text-[32px] font-bold text-white tracking-tight leading-[1.1] mb-4">
                Built around{" "}
                <span className="gradient-text">your account&rsquo;s safety.</span>
              </h2>
      ...
      ══════════════════════════════════════════════════════════════════ */}
      <section
        className="px-4 sm:px-6 lg:px-8 py-12 relative"
        style={{
          background:
            "linear-gradient(180deg, transparent 0%, rgba(8,17,31,0.55) 50%, transparent 100%)",
        }}
      >
        <div
          aria-hidden
