...
const operatingModel = [
  ...
  },
  {
    ...
    desc: "Each account submits a government-issued ID along with name and date of birth. Submissions are reviewed manually as part of our standard onboarding process, typically within one business day.",
  },
  {
    icon: ArrowDownToLine,
    title: "Deposits",
    desc: "Users request a deposit through a verified platform wallet address, optionally attaching a transfer reference and a proof screenshot. Each request is reviewed before the wallet is credited.",
  },
  {
    icon: ArrowUpFromLine,
    title: "Withdrawals",
    desc: "Withdrawals are submitted from the dashboard and verified before funds are released. Limits and processing times are shown before the user confirms the request.",
  },
  {
    icon: HeadphonesIcon,
    title: "Support & disputes",
    desc: `Verified users submit tickets directly from the dashboard. Responses are sent ${CONTACT.generalResponseWindow} during published hours. Escalations are routed to the compliance contact listed on the contact page.`,
  },
  {
    icon: Shield,
