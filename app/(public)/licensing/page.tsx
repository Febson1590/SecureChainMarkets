      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="glass-card rounded-2xl p-8 space-y-6 text-sm text-slate-400 leading-relaxed">
          <section>
            ...
            <p>
              SecureChainMarkets is a digital-asset brokerage platform operated by the company
          ...
          <section>
            ...
            <p>
              ...
              SecureChainMarkets is permitted to provide them. We do not offer services to
          ...
          <section>
            ...
            <p>
              ...
              {" "}
              <a href="/risk" className="text-[#2B6BFF] hover:text-[#5C8BFF]">/risk</a>
          ...
          <section>
            ...
            <p>
              SecureChainMarkets operates a transparent fee model. Trading fees are shown on
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-1">
              <li><a href="/aml" className="text-[#2B6BFF] hover:text-[#5C8BFF]">Anti-Money Laundering (AML) Policy</a></li>
              <li><a href="/kyc" className="text-[#2B6BFF] hover:text-[#5C8BFF]">Know Your Customer (KYC) Policy</a></li>
              <li><a href="/privacy" className="text-[#2B6BFF] hover:text-[#5C8BFF]">Privacy Policy</a></li>
              <li><a href="/terms" className="text-[#2B6BFF] hover:text-[#5C8BFF]">Terms of Service</a></li>
              <li><a href="/risk" className="text-[#2B6BFF] hover:text-[#5C8BFF]">Risk Disclosure</a></li>
            </ul>
          </section>
        </div>
      </div>
