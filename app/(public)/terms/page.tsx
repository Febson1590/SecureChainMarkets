      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="glass-card rounded-2xl p-8 space-y-6 text-sm text-slate-400 leading-relaxed">
          <section>
            ...
            <p>
              By creating a SecureChainMarkets account or using any part of the platform, you agree to
          ...
          <section>
            ...
            <p>
              ...
              to keep it updated. SecureChainMarkets may require identity verification (KYC) before unlocking
          ...
          <section>
            ...
            <p>
              Trades executed on SecureChainMarkets are final once confirmed. Prices and market data are
          ...
          <section>
            ...
            <p>
              ...
              times vary based on method, compliance checks, and network conditions. SecureChainMarkets
          ...
          <section>
            ...
            <p>
              You agree not to use SecureChainMarkets for any unlawful activity, including money laundering,
          ...
          <section>
            ...
            <p>
              SecureChainMarkets is provided on an &ldquo;as is&rdquo; and &ldquo;as available&rdquo; basis. To the
