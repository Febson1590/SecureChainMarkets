...
const monitoringItems = [
  {
    ...
    desc: "Every sign-in, balance change, deposit, withdrawal, and trade is written to an account activity log accessible from your dashboard.",
  },
  {
    icon: Eye,
    title: "Internal action audit",
    desc: "Privileged actions on the platform are recorded with actor ID, target account, and timestamp so balance adjustments and approvals are fully traceable.",
  },
  {
    icon: FileCheck2,
    title: "Manual review of funds movement",
    desc: "Deposits and withdrawals go through a manual review step before funds move. Nothing is auto-approved on funded accounts.",
  },
];
...
const verificationItems = [
  ...
  },
  {
    ...
    desc: "Each uploaded ID document, name, and date of birth goes through a manual review process. Typical review time is one business day during published hours.",
  },
];
